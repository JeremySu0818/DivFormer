...
class ConsoleUI:
    ...
    def header(ckpt: str, device: str, tokens: int):
        print("-" * 50)
        print(f" DivFormer Interactive Mode (Jeremy's Edition)")
...
def main():
    ...
    if not os.path.exists(ckpt_path):
        ckpts = get_sorted_checkpoints("divformer_ckpt")
        ckpt_path = select_checkpoint_interactive("divformer_ckpt", ckpts) or args.ckpt
